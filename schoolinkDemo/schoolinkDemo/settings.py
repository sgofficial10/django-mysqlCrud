"""
Django settings for schoolinkDemo project.
...
SECRET_KEY = 'x!ia4^fl4at$f0e06tafbfs=%&b%#%8)8xg%@5#p%h=fj6we2$'
...
ROOT_URLCONF = 'schoolinkDemo.urls'
...
WSGI_APPLICATION = 'schoolinkDemo.wsgi.application'
